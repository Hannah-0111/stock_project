...
def get_sise(company_code):
    ...
    # driver = webdriver.Chrome('/home/ubuntu/.local/bin/chromedriver.exe') # for ubuntu server
    # driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), chrome_options = options) # org
    # chromedriver_autoinstaller.install() # autoinstall
